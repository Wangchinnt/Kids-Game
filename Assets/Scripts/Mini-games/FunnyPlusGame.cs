...
public class FunnyPlusGame : MiniGame, IHaveCountingElement
{
    ...
    {
        gameName = "Funny Plus Game";
        isCompleted = false;
        _selectedAnswer = "-1";
        Debug.Log("Funny Plus Game Initialized");
        countingArea1.GameObject().SetActive(true);
        countingArea2.GameObject().SetActive(true);
    ...
    private void GenerateOperators()
    {
        ...
        while (operators[0] >= expectedValue)
        {
            operators[0] = Random.Range(valueRange[0], valueRange[1] + 1);
        }

        operators[1] = expectedValue - operators[0];
